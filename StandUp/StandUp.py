...
selected_studentsC20 = random.sample(C20, 2)
selected_studentsC21 = random.sample(C21, 2)

for student in selected_studentsC20:
    C20.remove(student)

for student in selected_studentsC21:
    C21.remove(student)

all_students = [(student, "C20") for student in C20] + [(student, "C21") for student in C21] + [(student, "C22") for student in C22]
...
groupe1.extend(selected_studentsC20 + selected_studentsC21)
groupe2.extend(selected_studentsC20 + selected_studentsC21)
groupe3.extend(selected_studentsC20 + selected_studentsC21)
