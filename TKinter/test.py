...
bouton1 = tk.Button(
    ...
    text="",  # Aucun texte
    cursor="hand2",
    relief="flat",  # Supprime la bordure du bouton
    command=afficher_message,
)
bouton1.config(image=photo, compound="center")  # Utilisez "center" pour centrer l'image dans le bouton
bouton1.image = photo  # Garde une référence à l'image pour éviter qu'elle ne soit supprimée
